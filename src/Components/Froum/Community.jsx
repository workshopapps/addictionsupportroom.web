      ...
      <div>
        <div className=' hidden laptop:block bg-[#FAFAFA] mt-20 border-[2px] rounded-[16px]'>
          ...
          <div 
            ...
            className={ ` hover:bg-[#B2B2B2] border-y-2 py-2 px-4 gap-5 flex cursor-pointer
              ${active === Beginnerposts ?  "bg-[#B2B2B2]" :" bg-[#FAFAFA]" }`}
          >
            <img src={c1} alt="img" className='w-[100px] h-[100px] ' />
            <div className=' my-auto'>
              <p className='text-[#3E3E3E] text-[16px] '>PUBLIC COMMUNITY</p>
          ...
          >
            <img src={c2} alt="img" className='w-[100px] h-[100px] ' />
            <div className=' my-auto'>
              <p className='text-[#3E3E3E] text-[16px] '>PUBLIC COMMUNITY</p>
          ...
          >
            <img src={c3} alt="img" className='w-[100px] h-[100px] ' />
            <div className=' my-auto'>
              <p className='text-[#3E3E3E] text-[16px] '>PUBLIC COMMUNITY</p>
          ...
          >
            <img src={c4} alt="img" className='w-[100px] h-[100px] ' />
            <div className=' my-auto'>
              <p className='text-[#3E3E3E] text-[16px] '>PUBLIC COMMUNITY</p>
