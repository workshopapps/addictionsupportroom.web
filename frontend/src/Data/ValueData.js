...
const ValueData = [
    ...
    },
    {
        ...
        content: ' We rely on our peers to improve. <br/> Be open,honest and kind.'
    },
    {
        id: 3,
        icon: <AiOutlineLineChart className="icon"/> ,
        header: 'Pride in what we do',
        content: 'Value quality and integrity in everything we do. At all <br/> times. No exceptions.'
    },
    {
        id: 4,
        icon: <CiFaceSmile className="icon"/> ,
        header: 'Care about our customer',
        content: 'Understand customers <br/> stated and unstated needs. '
    },
    {
        id: 5,
        icon: <RiFlag2Line className="icon"/> ,
        header: 'Do the impossible',
        content: 'Be energized by difficult problems. Revel in unknowns. <br/> Ask "Why?", but always question, "Why not?"'
    },
    {
        id: 6,
        icon: <TiFlashOutline className="icon"/> ,
        header: 'Sweat the small stuff',
        content: 'We believe the best products come from the best, <br/> attention to detail. Sweat the small stuff.'
    }
]
